...
// $mailer_user = 'no-reply@localhost.com';
...
$mailer_from = 'no-reply@localhost.com';
// $mailer_from = 'finance.s1@prasetiyamulya.ac.id';

//The 'From name' of the message
// $mailer_from_name = 'Finance S1';
$mailer_from_name = 'localhost';

//The 'Sender email' (Return-Path) of the message
//If not empty, will be sent via -f to sendmail or as 'MAIL FROM' in smtp mode
$mailer_sender = 'no-reply@localhost.com';
