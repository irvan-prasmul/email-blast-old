...
//SMTP username
$mailer_user = 'no-reply@pmbs.ac.id';//'noreply@pmbs.ac.id';//
...
$mailer_from = 'admission.s1@prasetiyamulya.ac.id';

//The 'From name' of the message
$mailer_from_name = 'Admission S1';

//The 'Sender email' (Return-Path) of the message
//If not empty, will be sent via -f to sendmail or as 'MAIL FROM' in smtp mode
//$mailer_sender = 'no-reply@prasetiyamulya.ac.id';
$mailer_sender = 'admission.s1@prasetiyamulya.ac.id';
